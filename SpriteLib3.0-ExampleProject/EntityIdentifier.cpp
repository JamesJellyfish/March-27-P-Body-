...
unsigned int EntityIdentifier::m_mainCharacterBit	= 0x10000000;
unsigned int EntityIdentifier::m_groundBit			= 0x2;
...
unsigned int EntityIdentifier::MainCharacterBit()
{
	return m_mainCharacterBit;
}
